  ...
  if (!otorol || otorol.toLowerCase() === "yok") return;
    ...
    try {
      ...
      if (!role) {
        ...
        var embed = new Discord.RichEmbed()
          .setDescription(
            `**Sunucuya Yeni Katılan** \`${member.user.tag}\` **Kullanıcısına** \`${role}\` **Rolü verildi. <aHg Karşim :D 696373472431177781>**`
          )
          .setColor("0x36393E")
